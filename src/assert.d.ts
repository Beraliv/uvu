...
export function equal<Actual, Expects extends Actual>(actual: Actual, expects: Expects, msg?: Message): void;
export function equal<Actual extends Expects, Expects>(actual: Actual, expects: Expects, msg?: Message): void;
export function equal<Actual, Expects>(actual: Actual, expects: Expects, msg?: Message): void;
